...
public class EmployeeValidator {
     ...
     * @param passwordCheckFlaf パスワードの入力チェックを実施するかどうか(実施する:true 実施しない:false)
     * @return エラーのリスト
     */
    ...
    /**
     * @param service EployeeServiceのインスタンス
     * @param code 社員番号
     ...
     * @param passwordCheckFlag パスワードの入力チェックを実施するかどうか(実施するtrue しない:false)
     * @return エラーメッセージ
     */
